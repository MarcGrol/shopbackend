...
//
//	mockgen -source=payer.go -package checkoutstripe -destination payer_mock.go Payer
//
...
func (mr *MockPayerMockRecorder) CreateCheckoutSession(ctx, params any) *gomock.Call {
